...
// tabData ko component ke bahar define karne se ye har render par dobara nahi banega.
// Isse performance behtar hoti hai.
const tabData = [
  {
    id: 1,
  ...
  },
  {
    id: 2,
    title: "Games",
    content: "It has clean classrooms and a big playground to play games."
  },
  {
    id: 3,
    title: "School Life",
  ...
  },
  {
    ...
    content: "School is an institution designed to provide learning spaces and learning environments for the teaching of students under the direction of teachers. Most countries have systems of formal education, which is commonly compulsory."
  }
];
            ...
            <div key={tab.id} className="border-b border-black">
              ...
              >
                <div className="flex justify-between items-center">
                  <h2 className="text-xl font-semibold text-black">{tab.title}</h2>
